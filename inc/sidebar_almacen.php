<?php
						...
						<ul class="sub-menu">
						<li  style="color:white; letter-spacing: 1px;"><a href="../process/reportes/stock_vendedor/index.php" target="_blank"><i class="fas fa-file-pdf"></i> <span>Stock General.</span></a></li>
                        <li  style="color:white; letter-spacing: 1px;"><a href="../process/reportes/stock_vendedor/index.php" target="_blank"><i class="fas fa-file-pdf"></i> <span>Stock Existente</span></a></li>
						...
						<li  style="color:white; letter-spacing: 1px;"><a href="../process/reportes/stock_vendedor/index.php" target="_blank"><i class="fas fa-file-pdf"></i> <span>Stock Categorias</span></a></li>    
                        </ul>
					</li>
					    </a>
						</li>
