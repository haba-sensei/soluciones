...
var dataTable1=$('#example2').DataTable({
    ...
    "lengthMenu": false,
    "ajax":{
        url:"../process/producto/actualizarStck.php",
        type:"post"
    }
});

var dataTable2=$('#stock_table').DataTable({
    "processing": true,
    "serverSide":true,
    "responsive": true,
    "iDisplayLength": "5",
    ...
    "lengthMenu": false,
    "ajax":{
        url:"../process/producto/actualizarStck_lista.php",
        type:"post"
    }
});  

var dataTable3=$('#agotado_table').DataTable({
    "processing": true,
    "serverSide":true,
    "responsive": true,
    "iDisplayLength": "5",
    ...
    "lengthMenu": false,
    "ajax":{
        url:"../process/producto/actualizarStckAgotado.php",
        type:"post"
    }
});
