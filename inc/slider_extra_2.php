<div id="new-extra-2" class="owl-carousel">
	...
	while ($row3 = mysqli_fetch_array($rev3,  MYSQLI_ASSOC)) {
		...
		echo "<form class='product-form'>
			...
			"<h5 class='price' style='position: absolute; margin-right: 27px;  margin-top: 11px;  font-size: 14px;'> Antes: <s>{$row3['moneda']} {$p_p} </s>&nbsp; SKU: {$row3['CodigoProd']}</h5>" .
