<div id="new-extra-3" class="owl-carousel">
	...
	while ($row5 = mysqli_fetch_array($rev4,  MYSQLI_ASSOC)) {
		...
		echo "<form class='product-form'>
			...
			"<h5 class='price' style='position: absolute; margin-right: 27px;  margin-top: 11px;  font-size: 14px;'> Antes: <s>{$row5['moneda']} {$p_p} </s>&nbsp; SKU: {$row5['CodigoProd']}</h5>" .
