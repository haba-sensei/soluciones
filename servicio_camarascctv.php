...
<?php
	...
	<!DOCTYPE html>
	<html lang="en"><link rel="shortcut icon" href="assets/img/favicon.png">	
<!-- CCS REDES SOCIALES  -->
</script>
...
<h1 class="section-title txt-rotate" data-period="2000" data-rotate='[ "Soporte de Camaras de Vigilancia CCTV " ]'></h1> 
			    	...
			    	<div id="accordion" class="card-accordion">
						...
						<div class="card">
							<div class="card-header pointer-cursor collapsed" data-toggle="collapse" data-target="#collapseSeven">
								#7 Soporte de Equipos Hikvision
							</div>
