...
<h1 class="section-title txt-rotate" data-period="2000" data-rotate='[ "Soporte de Radio Enlaces 2.4 - 5.8 " ]'></h1> 
			    	...
			    	<div id="accordion" class="card-accordion">
						...
						<div class="card">
							<div class="card-header pointer-cursor collapsed" data-toggle="collapse" data-target="#collapseFive">
								#5 Configuracion Firewall TCP/IP
							</div>
						...
						<div class="card">
							<div class="card-header pointer-cursor collapsed" data-toggle="collapse" data-target="#collapseSix">
								#6 Configuracion de AP Ubiquiti
							</div>
