...
<h1 class="section-title txt-rotate" data-period="2000" data-rotate='[ "Curso de Ensamblaje de Computadoras" ]'></h1> 
			    	...
			    	<div id="accordion" class="card-accordion">
						...
						<div class="card">
							<div class="card-header pointer-cursor collapsed" data-toggle="collapse" data-target="#collapseThree">
								#3 Tipos de Hardware en General
							</div>
