...
$body .= "         <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:22px!important; line-height:33px;color:#FFFFFF!important;'><strong>SOLUCIONES CCTV & SISTEMAS S.A.C</strong></p>";
$body .= "       </td>";
$body .= "   </tr>";
$body .= "  </table>";
$body .= " </td>";
...
$body .= "        <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Numero de Dni :&nbsp; ".$Ruc_Dni."</strong></p>";
$body .= "    </td>";
$body .= "          </tr>";
$body .= "   </table>";
$body .= "   </td>";
...
$body .= "              <tr style='border-collapse:collapse;'>";
$body .= "          <td align='left' style='padding:10px;Margin:0;'>";
$body .= "                 <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Curso Seleccionado :&nbsp;".$Curso."</strong></p>";
$body .= "               </td>";
$body .= "             </tr>";
$body .= "           </table>";
$body .= "        </td>";
...
$body .= "             <tr style='border-collapse:collapse;'>";
$body .= "             <td align='left' style='padding:10px;Margin:0;'>";
$body .= "                    <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Tipo de Contacto :&nbsp;".$Tipo."</strong></p>";
$body .= "        </td>";
$body .= "      </tr>";
$body .= "   </table>";
$body .= "   </td>";
...
$body .= "             <tr style='border-collapse:collapse;'>";
$body .= "                <td align='left' style='padding:10px;Margin:0;'>";
$body .= "                    <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Dias de la Semana :&nbsp;".$dia."</strong></p>";
$body .= "     </td>";
$body .= "    </tr>";
$body .= "    </table>";
$body .= "  </td>";
...
$body .= "         <tr style='border-collapse:collapse;'>";
$body .= "           <td align='left' style='padding:10px;Margin:0;'>";
$body .= "               <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Horario de Preferencia &nbsp;:&nbsp;".$Horario."</strong></p>";
$body .= "      </td>";
$body .= "   </tr>";
$body .= "   </table>";
$body .= "  </td>";
...
$body .= "     <tr style='border-collapse:collapse;'>";
$body .= "        <td align='left' style='padding:10px;Margin:0;'>";
$body .= "           <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'noticia text', georgia, 'times new roman', serif;line-height:24px;color:#333333;'><strong>Turno Escogido &nbsp;:&nbsp;".$Turno."</strong></p>";
$body .= "         </td>";
$body .= "       </tr>";
$body .= "    </table>";
$body .= "  </td>";
...
$mail->Username = "cursos@solucionescctvysistemas.com";  // SMTP username
...
$mail->AddAddress("cursos@solucionescctvysistemas.com", "cursos");
