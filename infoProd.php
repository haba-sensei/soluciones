            ...
            <div id="get_quote" class="ajuste">
                <div class="container animated fadeInUp">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button class="button-two bton-serv hidden-xs" onclick="window.location.href='view_cart.php'"><span>¿ COMPRA AQUI ?</span></button>
                        </div>
                    </div><!-- End row -->
                </div><!-- End container -->
            </div>
                                ...
                                <section class="jsx-4113348717 pdp-image-section">
                                    <div class="jsx-2128732992 jsx-55879769 imageGallery fa--image-gallery">
                                        ...
                                        <div class="jsx-2134917503 headline-wrapper fa--image-gallery-item__desktop">
                                            ...
                                            <img id="product-zoom"
                                            src="assets/img-products/<?php echo  $imagen; ?>"
                                            data-zoom-image="assets/img-products/<?php echo $imagen; ?>"
                                            alt="" width="800" height="800" class="jsx-2487856160" />
                                        </div>
                                        ...
                                        <div class="product-top">
                                            <div class="pro-img">
                                                <a href="infoProd.php?CodigoProd=<?php echo  $CodigoProducto; ?>">
                                                    <img alt="" style="height:268px!important; border-bottom: 1px solid #005a8f;" src="assets/img-products/<?php echo  $Imagen_slider2; ?>">
                                                </a>
                                            </div>
