	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active">Buscar Delivery</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Busqueda de Delivery <small> Modulo de Delivery</small></h1>
                  ...
                  <tr>
					 ...
					 <td><?php echo $fecha_coti ?></td>
                       ...
                       <td style="display: flex;">
                          <button class="btn btn-block btn-new"  onclick="enviarDelivery('<?=$id_coti?>')" style="margin-right: 10px; margin-top: 8px; margin-left: 10px;" ><i class="fas fa-plus fa-fw"></i> Imprimir  </button>
