                ...
                <ul class="nav">
                    ...
                    <div id="content" class="content">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">Lista de Cotizacion Aprobadas</li>
                        </ol>
                        <!-- end breadcrumb -->
                        <!-- begin page-header -->
                        <h1 class="page-header">Lista de Cotizacion Aprobadas<small> Modulo de Cotizacion</small></h1>
                        <div class="row">
                        ...
                        <?php include '../process/cotiza/cotiza_aprob.php'; ?>
