                ...
                <ul class="nav">
                    ...
                    <div id="content" class="content">
                        ...
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">Lista de Pedidos Totales</li>
                        </ol>
                        <!-- end breadcrumb -->
                        <!-- begin page-header -->
                        <h1 class="page-header">Lista de Pedidos Totales<small> Modulo de Pedidos</small></h1>
...
?>
                        ...
                        <?php include '../process/pedido/pedido_totales.php'; ?>
