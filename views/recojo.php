	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Recojo en Tienda</a></li>
				<li class="breadcrumb-item active">Buscar Recojo en Tienda</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Busqueda de Recojo en Tienda <small> Modulo de Recojo en Tienda</small></h1>
	 ...
	 <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Lista de Recojos en Tienda</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
