...
<div class="table-responsive">
            ...
            <thead class="bg-blue">
                  ...
                  WHERE `cotizacion_online`.`Estado` = '4' AND `detalle_compra_online`.`id_cotizacion` = `cotizacion_online`.`id_cotizacion`");
                  ...
                  <tr>
                    ...
                    ?></td>
                       ...
                       <td style="display: flex;">
                          ...
                          <button class="btn btn-block btn-elim"  onclick="regresarDelivery(&quot;<?php echo $id_coti ?>&quot;)" style="margin-right: 10px; margin-top: 8px; margin-left: 10px;"  ><i class="fas fa-minus fa-fw"></i> Delivery Regresado</button>
