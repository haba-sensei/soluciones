	    ...
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	            ...
	            <table class="table table-bordered ">
                    ...
                    // 643.38
               $general = round($totalGeneral_sin_formato * $globalTasaCambio_dolar - $descuento, 2);
               ...
               $igv_cifra = round($general / 1.18 , 2, PHP_ROUND_HALF_UP);


               $subtotal = $igv_cifra ;
               $monto_igv_format = round($general - $subtotal, 2);
            //    number_format($subtotal_final - ($subtotal_final / $import), 2);$general - $subtotal
               $total_a_cuenta = 0.00;
               $total_tarjeta = 0.00;
