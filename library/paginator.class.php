...
class Paginator {
    ...
    public function createLinks( $links ) {
        ...
        $html       .= '<li class="' . $class . ' "><a href="?limit=' . $this->batas . '&page=1">&laquo;</a></li>';
        $html       .= '<li class="' . $class . ' "><a href="?limit=' . $this->batas . '&page=' . ( $this->halaman - 1 ) . '">&lsaquo;</a></li>';
        ...
        $html       .= '<li class="' . $class . ' "><a href="?limit=' . $this->batas . '&page=' . ( $this->halaman + 1 ) . '">&rsaquo;</a></li>';
        $html       .= '<li class="' . $class . ' "><a href="?limit=' . $this->batas . '&page=' . ( $last ) . '">&raquo;</a></li>';
